...
function batchFormatter(cell, row) {
  if (!row.batch) {
    return <div>---</div>;
  }
}
function ppaFormatter(cell, row) {
  if (!row.ppa) {
    return <div>---</div>;
  }
}
...
export class BeneficiaryLists extends Component {
  ...
  componentDidMount() {
    // console.log(data);
    let x = axios.get(
      `https://sleepy-wildwood-51098.herokuapp.com/supervisor/beneficiary/NPOWER`
    );
    let y = axios.get(
      `https://sleepy-wildwood-51098.herokuapp.com/supervisor/beneficiary/tradermoni`
    );

    Promise.all([x, y])
      .then((res) => {
        console.log(res);
        let npower = res[0].data;
        let traderMoni = res[1].data;
        console.log(traderMoni);
        this.setState({
          allSchemes: data,
          npower,
          traderMoni,
  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <ul
            className="container nav nav-pills  mb-3 tab-pills"
            id="pills-tab"
            role="tablist"
          >
            ...
            <li className="nav-item">
              <a
                className="nav-link"
                id="pills-beneficiaries-tab"
                data-toggle="pill"
                href="#pills-beneficiaries"
                role="tab"
                aria-controls="pills-beneficiaries"
                aria-selected="false"
              >
                Beneficiaries
              </a>
        ...
        <div className="tab-content" id="pills-tabContent">
          ...
          <div
            ...
            id="pills-beneficiaries"
            role="tabpanel"
            aria-labelledby="pills-beneficiaries-tab"
          >
            <div>
              <ul
                className="container nav nav-pills  mb-3 tab-pills"
              ...
              >
                <li className="nav-item border-0">
                  <a
                    onClick={() => this.toggleData("npower")}
                ...
                <li className="nav-item">
                  <a
                    onClick={() => this.toggleData("tradermoni")}
                    className="nav-link border-0"
                    id="pills-profile-tab"
                    data-toggle="pill"
                    href="#pills-trader-moni"
                    role="tab"
                    ...
                    <div class="page-header mt-5">
                      <div class="row align-items-center">
                        <div class="col-12 my-2">
                          <h3 class="mt-3">
                            {this.state.displayText} BENEFICIARY LIST
                          </h3>
                        </div>
                        <div class="col ">
